...
// const words = ["REACT", "NATIVE", "JAVASCRIPT", "AHORCADO"]; // Lista de palabras
const countries = [
  ...
  "GABÓN", "GAMBIA", "GHANA", "GEORGIA", "GRANADA", "GRECIA", "GUATEMALA", "GUINEA", "GUINEA-BISSAU", 
  "GUYANA", "HAITÍ", "HONDURAS", "HUNGRÍA", "INDIA", "INDONESIA", "IRAK", "IRÁN", "IRLANDA", 
  "ISLANDIA", "ISRAEL", "ITALIA", "JAMAICA", "JAPÓN", "JORDANIA", "KAZAJISTÁN", "KENIA", "KIRGUISTÁN", 
  "KIRIBATI", "KOSOVO", "KUWAIT", "LAOS", "LESOTO", "LETONIA", "LÍBANO", "LIBERIA", "LIBIA", 
  "LIECHTENSTEIN", "LITUANIA", "LUXEMBURGO", "MADAGASCAR", "MALASIA", "MALAWI", "MALDIVAS", "MALÍ", 
  ...
  "NIGERIA", "NORUEGA", "NUEVA ZELANDA", "OMÁN", "PAÍSES BAJOS", "PAKISTÁN", "PALAU", "PANAMÁ", 
  "PAPÚA NUEVA GUINEA", "PARAGUAY", "PERÚ", "POLONIA", "PORTUGAL", "REINO UNIDO", "REPÚBLICA CENTROAFRICANA", 
  "REPÚBLICA CHECA", "REPÚBLICA DEMOCRÁTICA DEL CONGO", "REPÚBLICA DOMINICANA", "REPÚBLICA DEL CONGO", 
